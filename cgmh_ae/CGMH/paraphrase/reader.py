    ...
    if file_name[-3:]=='pkl':
        ...
        with open(file_name) as f:
            ...
            for line in f:
                ...
                # fixed tokenization! split is not enough
                # samples: How do I read and find my YouTube comments?
                # This cannot be easily done by splitting by space as ? mark
                # is concatenated to the previous word
                data.append(sen2id([w.lower() for w in pos]))
