class config(object):
    def __init__(self):
        ...
        self.use_data_path= './input/train.txt'  #                                    #data path of original sentences
        ...
        # self.search_ae=['wae-det', 'vae', 'wae-stochastic']
        self.use_output_path='./output/test/output.txt'         #output path
