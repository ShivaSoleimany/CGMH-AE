...
def model_argparse():
    ...
    parser.add_argument("--batch_size", type=int, default=1, help='batch size') # Note: Changed to 1 for prediction
    ...
    parser.add_argument("--data", type=str, default='/mnt/hope/hope/probabilistic_nlg/snli/data/snli_sentences_all.txt')
    parser.add_argument("--w2v_file", type=str, default='/mnt/hope/hope/probabilistic_nlg/snli/w2v_models/w2v_300d_snli_all_sentences.pkl')
