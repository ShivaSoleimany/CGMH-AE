...
import numpy as np
from hope.probabilistic_nlg import utils
import hope.probabilistic_nlg.snli.wae_stochastic.gl
import os
from tqdm import tqdm
from nltk.tokenize import word_tokenize
from tensorflow.python.layers.core import Dense
from hope.probabilistic_nlg.snli.decoder import basic_decoder
...
class StochasticWAEModel(object):
    ...
    def predict(self, checkpoint, x_test, sess=None):
        pred_logits = []
        hypotheses_test = []
        references_test = []
