...
from hope.probabilistic_nlg.snli.wae_stochastic.pathsetup import run_path_setup
run_path_setup()

import os
from hope.probabilistic_nlg.snli.wae_stochastic import gl
gl.isTrain = False

from hope.probabilistic_nlg.snli.wae_stochastic.model_config import model_argparse
...
from hope.probabilistic_nlg.snli.wae_stochastic.stochastic_wae import StochasticWAEModel
from sklearn.model_selection import train_test_split

np.random.seed(1337)

absolute_path = '/mnt/hope/hope/probabilistic_nlg/snli/wae_stochastic'
...
#----------------------------------------------------------------#
config['ckpt'] = '/mnt/hope/hope/probabilistic_nlg/snli/wae_stochastic/models/full_snli_lambdaWAE0.0_batch128_gammaKL_1.0_kernel_IMQ_num_tokens_20/20.ckpt'
