...
from hope.probabilistic_nlg.snli.wae_det.pathsetup import run_path_setup
run_path_setup()

import os
from hope.probabilistic_nlg.snli.wae_det import gl
gl.isTrain = False

from hope.probabilistic_nlg.snli.wae_det.model_config import model_argparse
...
from hope.probabilistic_nlg.snli.wae_det.det_wae import DetWAEModel
...
config['ckpt'] = '/mnt/hope/hope/probabilistic_nlg/snli/wae_det/models/full_snli_lambdaWAE3.0_batch128_kernel_IMQ_num_tokens_20/20.ckpt'
